...
const MyApplications = () => {
  ...
  const dummyApplications = [
    {
      _id: "1",
      jobInfo: { jobTitle: "Software Engineer" },
      jobSeekerInfo: {
        name: "John Doe",
  ...
  // Use dummy data if applications is empty
  const appsToDisplay =
    applications.length > 0 ? applications : dummyApplications;
            ...
            {appsToDisplay.map((element) => (
              ...
              >
                <div className="mb-4">
                  <p className="text-lg font-bold mb-1">Job Title:</p>
                  <p className="text-gray-700">
                    {element.jobInfo?.jobTitle || "N/A"}
                  </p>
                </div>
                <div className="mb-4">
                  <p className="text-lg font-bold mb-1">Name:</p>
                  <p className="text-gray-700">
                    {element.jobSeekerInfo?.name || "N/A"}
                  </p>
                </div>
                <div className="mb-4">
                  <p className="text-lg font-bold mb-1">Email:</p>
                  <p className="text-gray-700">
                    {element.jobSeekerInfo?.email || "N/A"}
                  </p>
                </div>
                <div className="mb-4">
                  <p className="text-lg font-bold mb-1">Phone:</p>
                  <p className="text-gray-700">
                    {element.jobSeekerInfo?.phone || "N/A"}
                  </p>
                </div>
                <div className="mb-4">
                  <p className="text-lg font-bold mb-1">Address:</p>
                  <p className="text-gray-700">
                    {element.jobSeekerInfo?.address || "N/A"}
                  </p>
                </div>
                <div className="mb-4">
                  <p className="text-lg font-bold mb-1">Cover Letter:</p>
