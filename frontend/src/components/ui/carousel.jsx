    ...
    <div ref={carouselRef} className="tailwind.config.jsoverflow-hidden">
      <div
        ...
        className={cn(
          ...
          orientation === "horizontal"
            ? "tailwind.config.js-ml-4"
            : "tailwind.config.js-mt-4 tailwind.config.jsflex-col",
          className,
        )}
        {...props}
      />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ? "tailwind.config.jspl-4"
          : "tailwind.config.jspt-4",
        className,
      )}
      {...props}
    />
  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <span className="tailwind.config.jssr-only sr-only">
          Previous slide
        </span>
      </Button>
    );
  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <span className="tailwind.config.jssr-only sr-only">Next slide</span>
      </Button>
    );
  },
);
